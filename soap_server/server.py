...
class ColumnModel(ComplexModel):
    type = Unicode
    name = Unicode
    default = Unicode
...
class DBManagerService(ServiceBase):
    ...
    def get_table(self, name):
        ...
        return TableModel(name=table.name,
                          columns=[ColumnModel(type=col.type, name=col.name, default=col.default) for col in
    ...
    @rpc(Unicode, ColumnModel, _returns=None)
    def add_column(self, table_name, column):
        col = Column(column.type, column.name, column.default)
